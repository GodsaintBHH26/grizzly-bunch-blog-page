  ...
  return (
    <>
      <div className="flex flex-col items-center min-h-screen relative">
        <div className="flex flex-col items-center w-full overflow-y-auto relative">
              ...
              <AnimatedContent>
                <div className=" text-black flex flex-col gap-10 font-bold">
                  ...
                  <p className="text-2xl font-normal">
                    ...
                    ideas as much as you do. <br /> From personal stories, tips, and
                    experiences to trending topics and creative insights,
          ...
          <div className="bg-white w-full h-128 text-5xl">
            <div className="bg-black/20 w-full h-118 mt-10">
